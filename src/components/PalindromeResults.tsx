...
export default function PalindromeResults({
  results,
  isLoading,
}: PalindromeResultsProps) {
  if (isLoading) {
    return (
    ...
    return (
      <div className="w-full max-w-4xl mx-auto p-6">
        <div className="text-center py-8 text-zinc-500">
          <p>
            No palindromes generated yet. Enter a starting point above and click
            &ldquo;Generate Palindromes&rdquo;.
          </p>
        </div>
      </div>
    );
